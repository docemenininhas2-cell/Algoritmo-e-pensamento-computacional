...
celsius e farenheit. Para a execução tudo o que se deve fazer é a escolha da opção deseja de acordo com o menu que é apresentada, indicar na caixa de resposta
o valor da opção, um número e aguardar pelo resultado. É um programa fácil e acessível com valores exatos e precisos de acordo com a necessidade.
